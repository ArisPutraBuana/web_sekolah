            ...
            <div class="row">
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        ...
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span>Palembang, Sumatera Selatan, INA. 11001
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="single-item">
                        <div class="quote">
                            ...
                            <p class="quote_text">MSCHOOL benar-benar mengagumkan. Saya sangat senang bisa bergabung dengan MSCHOOL dan menjadi siswa terbaik tahun 2019.</p>
                            <div class="testi-img_block">
                                <img src="<?php echo base_url() . 'theme/images/student-1.png' ?>" class="img-fluid" alt="#">
                                <p><span>Aris Putra Buana</span>Siswa Terbaik 2019</p>
                            </div>
                        </div>
                        <div class="quote">
                            <i class="fa fa-quote-left" aria-hidden="true"></i>
                            <p class="quote_text">MSCHOOL benar-benar mengagumkan. Saya sangat senang bisa bergabung dengan MSCHOOL dan menjadi siswa terbaik tahun 2020. </p>
                            <div class="testi-img_block">
                                <img src="<?php echo base_url() . 'theme/images/student-2.png' ?>" class="img-fluid" alt="#">
                                <p><span>Meyka Setyawati</span>Siswa Terbaik 2020</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="foot-logo">
                        ...
                        <p><?php echo date('Y'); ?> © <a href="https://ArisPutraBuana.github.io" target="_blank">
                                Aris Putra Buana</a></p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sitemap">
                ...
                <div class="col-md-3">
                    <div class="address">
                        <h3>Hubungi Kami</h3>
                        <p><span>Alamat : </span> Palembang, Sumatera Selatan, INA. 11001</p>
